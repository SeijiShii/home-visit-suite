// desktop/frontend/src/pages/RegionManagementPage.tsx からの移植。
// Wails RegionBinding を RegionRepositoryBindingAdapter（regionRepo 包み）に置換した。
...
export function RegionManagementPage() {
  ...
  const { regionRepo } = useServices();
  const service = useMemo(
    () => new RegionService(new RegionRepositoryBindingAdapter(regionRepo)),
    [regionRepo],
  );
