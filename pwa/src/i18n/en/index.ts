...
const en: Translations = {
  ...
  map: {
    ...
    mergeDeleteConfirm: "This operation will delete a polygon. Continue?",
    mergeDeleteOk: "Delete",
    mergeDeleteCancel: "Cancel",
    undo: "Undo",
    redo: "Redo",
    ...
    areaAlreadyLinkedHere: "Already linked to this polygon",
    addExclavePolygon: "Add exclave polygon",
    multipleAreas: "Multiple areas",
    selectAreaToUnlink: "Select area to unlink",
    selectVisitArea: "Select area to open visit records",
  ...
  visitRecord: {
    ...
    buildingRoomsDiscardConfirm: "Discard room changes?",
  ...
  feedback: {
    title: "Feedback",
    sendSection: "Send Feedback",
    sendDescription:
      "Send bug reports or messages of support to your group admins or the developer",
    destinationLabel: "To",
    destinationAdmin: "Group admins",
    destinationDeveloper: "Developer",
    kindLabel: "Type",
    kinds: {
      bugReport: "Bug report",
      encouragement: "Message of support",
      other: "Other",
    },
    bodyLabel: "Message",
    ...
    send: "Send",
    sending: "Sending...",
    sentAdmin: "Sent to your group admins",
    sentDeveloper: "Sent to the developer",
    sendFailed: "Failed to send. Check your connection and try again",
    noDestinationNote:
      "No destination is available right now. Join a group to send feedback to its admins",
    ttlNote:
      "Messages to the developer are held at the relay node for up to 14 days. They expire if the recipient does not come online in time",
    historySection: "Sent Feedback",
    historyEmpty: "No feedback sent yet",
    historyLoading: "Loading...",
    replyFrom: "Reply from the developer",
    inboxSection: "Received Feedback",
    inboxEmpty: "No feedback received",
    statusPending: "Open",
    statusResolved: "Resolved",
    setPending: "Reopen",
    setResolved: "Mark resolved",
    devInboxSection: "Developer Inbox",
    devInboxEmpty: "No feedback received",
    refresh: "Check for messages",
    refreshing: "Checking...",
    refreshFailed: "Failed to check. Verify your connection and try again",
    reply: "Reply",
    ...
    replied: "Replied",
    replyFailed:
      "Failed to send the reply. Check your connection and try again",
  },
  regionManagement: {
