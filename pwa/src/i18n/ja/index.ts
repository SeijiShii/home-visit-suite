...
const ja: Translations = {
  ...
  map: {
    ...
    areaAlreadyLinkedHere: "このポリゴンに紐づけ済み",
    addExclavePolygon: "飛地ポリゴンを追加",
    multipleAreas: "複数の区域",
    selectAreaToUnlink: "紐づけを解除する区域を選択",
    selectVisitArea: "訪問記録を開く区域を選択",
  ...
  visitRecord: {
    ...
    buildingRoomsDiscardConfirm: "部屋の変更を破棄しますか？",
  ...
  requests: {
    title: "申請管理",
    searchPlaceholder: "区域IDまたは区域名で検索",
    statusLabel: "ステータス",
    statusPending: "未処理",
    statusOnHold: "保留",
    statusResolved: "処理済み",
    createdDateLabel: "申請日",
    resolvedDateLabel: "処理日",
    dateRangeSeparator: "〜",
    createdFromLabel: "申請日（から）",
    createdToLabel: "申請日（まで）",
    resolvedFromLabel: "処理日（から）",
    resolvedToLabel: "処理日（まで）",
    loading: "読み込み中...",
    empty: "申請はありません",
    noMatch: "条件に一致する申請はありません",
    setPending: "未処理に戻す",
    setOnHold: "保留にする",
    setResolved: "処理済みにする",
    openVisitPage: "訪問記録へ",
  ...
  feedback: {
    title: "フィードバック",
    sendSection: "フィードバックを送る",
    sendDescription:
      "バグ報告や応援メッセージをグループ管理者または開発者に送れます",
    destinationLabel: "宛先",
    destinationAdmin: "グループ管理者",
    destinationDeveloper: "開発者",
    kindLabel: "種別",
    kinds: {
      bugReport: "バグ報告",
    ...
    send: "送信",
    sending: "送信中...",
    sentAdmin: "グループ管理者に送信しました",
    sentDeveloper: "開発者に送信しました",
    sendFailed: "送信に失敗しました。通信環境を確認して再試行してください",
    noDestinationNote:
      "現在送信できる宛先がありません。グループに参加すると管理者宛に送信できます",
    ttlNote:
      "開発者宛のメッセージは中継ノードに最大14日間保管されます。期間内に相手がオンラインにならない場合は届きません",
    historySection: "送信履歴",
    historyEmpty: "送信したフィードバックはありません",
    historyLoading: "読み込み中...",
    replyFrom: "開発者からの返信",
    inboxSection: "受信フィードバック",
    inboxEmpty: "受信したフィードバックはありません",
    statusPending: "未処理",
    statusResolved: "処理済み",
    setPending: "未処理に戻す",
    setResolved: "処理済みにする",
    devInboxSection: "開発者受信ボックス",
    devInboxEmpty: "受信したフィードバックはありません",
    refresh: "受信を確認",
    refreshing: "確認中...",
    refreshFailed:
      "受信確認に失敗しました。通信環境を確認して再試行してください",
    reply: "返信",
    replySend: "返信を送信",
    replySending: "送信中...",
    ...
    replied: "返信済み",
    replyFailed:
      "返信の送信に失敗しました。通信環境を確認して再試行してください",
  },
  regionManagement: {
    title: "領域管理",
    addRegion: "領域を追加",
