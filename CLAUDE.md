...
- `docs/wants/` にテーマ別に仕様を記載
  - 共通基盤.md - データ構造方針、用語定義、実行環境、データインフラ
  - 領域と区域.md - 領域・区域親番・区域の定義と体系
  - 地図機能.md - ポリゴン編集、紐付け、住宅情報
  - ユーザー管理と権限.md - ロール、招待・任免、承認フロー
  - 訪問活動とチーム.md - チーム組成、訪問活動データ、区域割り当て
  - 網羅管理.md - 網羅活動、進捗管理、予定管理
  - 通知と申請.md - 通知、申請取扱い、監査ログ、データ保持
  - 活動スタッフ向けアプリ.md - 訪問記録、最新状況、場所データ
  - 継続的検討事項.md
