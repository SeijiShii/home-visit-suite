export namespace models {
	...
	export class CheckoutInvitation {
	    id: string;
	    checkoutId: string;
	    inviteeId: string;
	    inviterId: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new CheckoutInvitation(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.revokedAt = this.convertValues(source["revokedAt"], time.Time);
	        this.createdAt = this.convertValues(source["createdAt"], time.Time);
	    }
...
export namespace service {
	...
	export class AccessibleArea {
	    ...
	    static createFrom(source: any = {}) {
	        return new AccessibleArea(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.checkoutId = source["checkoutId"];
	        this.role = source["role"];
	        this.inviteExpiresAt = this.convertValues(source["inviteExpiresAt"], time.Time);
	    }
