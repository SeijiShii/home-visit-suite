...
const en: Translations = {
  ...
  checkouts: {
    ...
    inviteDlgGroupFilter: "Group",
    inviteDlgGroupAll: "All groups",
  ...
  coverage: {
    ...
    schedule: {
      ...
      availability: "Takeout Status",
      noAvailability: "No takeout status configured",
      addAvailability: "Add Takeout Status",
      type: "Type",
      lendable: "Lendable",
      selfTake: "Self Take",
      area: "Area",
      ...
      errorOutOfRange: "Date must be within the schedule period",
      assigned: "Assigned",
      bulkLendable: "Set all to Lendable",
      bulkSelfTake: "Set all to Self Take",
      bulkChangeStatus: "Change status (bulk)",
      bulkSelectedCount: "Selected: {n}",
    },
  },
  requests: {
    title: "Requests",
  ...
  settingsDev: {
    ...
    deleteAllSchedules: "Delete all schedule periods",
