...
const ja: Translations = {
  ...
  checkouts: {
    ...
    inviteDlgGroupFilter: "グループ",
    inviteDlgGroupAll: "すべてのグループ",
  ...
  coverage: {
    ...
    schedule: {
      ...
      availability: "持ち出しステータス",
      noAvailability: "持ち出しステータスが設定されていません",
      addAvailability: "持ち出しステータスを追加",
      type: "種別",
      lendable: "貸し出し可能",
      selfTake: "持ち出し可能",
      area: "区域",
      ...
      errorGeneric: "操作に失敗しました",
      errorDateOrder: "終了日は開始日より後に設定してください",
      errorOutOfRange: "予定期間内の日付を指定してください",
      assigned: "割当済",
      bulkLendable: "全て貸し出し可能に",
      bulkSelfTake: "全て持ち出し可能に",
      bulkChangeStatus: "ステータスを一括変更",
      bulkSelectedCount: "選択中: {n} 件",
    },
  },
  requests: {
    title: "申請管理",
  ...
  settingsDev: {
    ...
    deleteAllSchedules: "予定データをすべて削除",
    confirmRegions:
